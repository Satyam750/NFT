  ...
  return(
    <FooterStyled>
      <nav>
        ...
        <div className="logo">
        <Image src={logo} width={36} alt="logo" className="h-auto w-auto"/>
        <h2>S.R</h2>
        </div>
        <div className="input">
        ...
        <p>  Create, Sell And Collect Truly Rare Digital Artworks. Powered By
      ...
      <p className="rights">
        <a href="">©2024 S.R . All rights reserved.</a>
